<template>
  <div class="home-wrap">
    ...
    <div class="play-container">
      <div v-if="configBg && configBg !== ''" class="bg-img" :style="{ backgroundImage: `url(${configBg})` }"></div>
      <video v-if="configVideo && configVideo !== ''" class="bg-video" :src="configVideo" muted autoplay loop></video>
      <!-- <div class="slider-wrap">
        <div v-for="(item, index) in interactionList" :key="index">
          <Slider v-if="item.length" :list="item" :width="docW" :speed="60" :direction="index % 2 === 0 ? 'l-r' : 'r-l'"
            :customStyle="{ margin: '0 auto' }"></Slider>
        </div>
      </div> -->

      <div class="container">
        <div v-loading="videoLoading" class="left" ref="videoWrapTmpRef" @click="showJoinBtn = !showJoinBtn">
          <div v-if="
          ...
          <div v-if="currentLiveRoom?.live_room?.flv_url" ref="remoteVideoRef"></div>
          <template v-if="currentLiveRoom">
            <VideoControls @click.stop :resolution="videoResolution" @refresh="handleRefresh" :control="{
                line: true,
              }"></VideoControls>
            <div class="join-btn" :class="{
                show: showJoinBtn,
              }">
              <div class="btn" @click="joinRoom({ roomId: currentLiveRoom.live_room?.id! })">
                进入直播
              </div>
            </div>
          </template>
        ...
        <div class="right">
          <div v-if="topLiveRoomList.length" class="list">
            <div v-for="(item, index) in topLiveRoomList" :key="index" :class="{
                item: 1,
              ...
              <div v-if="item.live_room_id === currentLiveRoom?.live_room_id" class="triangle"></div>
    ...
    <div class="area-container">
      <div class="area-item">
        ...
        <div class="live-room-list">
          <div v-for="(iten, indey) in otherLiveRoomList" :key="indey" class="live-room" @click="
              joinRoom({
